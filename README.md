...
You don't need to use frameworks, components and client side routing to gain the benefit of it either. Let's say that you have a complex piece of code that only needs to be run when `.giganto-widget`
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYyOTg5MDMyOCwzNTIyMzU1OTMsLTc2OT
UxNTQyXX0=
-->
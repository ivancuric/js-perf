...
Fundamentally, the problem of most non-performant JS is not running the code itself, but all the steps that have to be taken _before_ the code even s
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjMxNTk0NjA3LDM1MjIzNTU5MywtNzY5NT
E1NDJdfQ==
-->
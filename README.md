...
2. Every JS framework ((P)Reac you use is another level of abstraction (unless it's a precompiled one, like [Svelte](https://github.com/sveltejs/svelte)). Not only will it increase your bundle size, but also slow down your code.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA5Njk2NjIzMSwzNTIyMzU1OTMsLTc2OT
UxNTQyXX0=
-->
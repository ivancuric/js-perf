...
If the browser isn't able to evaluate an `async` function, we assume that it's an old browser and just ship the poly
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MjUxNjE4NjcsMzUyMjM1NTkzLC03Nj
k1MTU0Ml19
-->
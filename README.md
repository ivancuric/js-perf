...
You might have noticed that the bottleneck is JavaScript download, parse and load time. There's no way around it but to load less 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk4OTcxOTQ2MV19
-->
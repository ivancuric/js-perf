...
Fundamentally, the problem of most non-performant JS is not running the code itself, but all the steps that have to be taken _before_ t
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQyMzI1ODU0MCwzNTIyMzU1OTMsLTc2OT
UxNTQyXX0=
-->
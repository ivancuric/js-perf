...
If the browser isn't able to evaluate an `async` function, we assume that it's an old browser and just ship the polyfilled bundle
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDczMDkzNjMxLDM1MjIzNTU5MywtNzY5NT
E1NDJdfQ==
-->
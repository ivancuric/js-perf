...
What I would like you to take out from this article is that JS is expensive and should be used sparingly. Make sure you test your website's performance on low-end devices, on real network coditions. 

The most expensive part for the browser (and your users)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDE2NjU2ODY2LDM1MjIzNTU5MywtNzY5NT
E1NDJdfQ==
-->
...
Another _very_ important thing to mention is that JavaScript is single-threaded, and runs on the browser's main thread. Meaning that only one process can run at a time. If your dev tools performance timeline is filled with yellow peaks
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQzMjgwNjkzMCwzNTIyMzU1OTMsLTc2OT
UxNTQyXX0=
-->
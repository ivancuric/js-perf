...
2. Every JS framework you use is another level of abstraction (unless it's a precompiled one, like [Svelte](https://github.com/sveltejs/svelte)). Not only 
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjQyMTY2NjkxLDM1MjIzNTU5MywtNzY5NT
E1NDJdfQ==
-->
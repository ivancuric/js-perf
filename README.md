...
You don't need to use frameworks, components and client side routing to gain the benefit of it either. Let's say that you have a complex piece of code that only needs to be run when `.kitchens
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA2NjMyNjQ4MSwzNTIyMzU1OTMsLTc2OT
UxNTQyXX0=
-->
...
Then there's the topic of transpiled code and polyfills. If you are writing modern javascript, you're probably using babel to transpile it into ES5
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYzMTczNTUwMCwzNTIyMzU1OTMsLTc2OT
UxNTQyXX0=
-->